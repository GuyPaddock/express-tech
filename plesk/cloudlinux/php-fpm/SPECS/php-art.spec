# For ART-build
%define with_atomicscl  %{?_with_atomicscl:  1} %{?!_with_atomicscl:  0}
%if %{with_atomicscl}
%global scl atomic-php54
%define _scl_prefix /opt/atomic
%define atomicname php54
%endif
...
%if 0%{?rhel} < 6
%global _root_initddir    /etc/init.d/
%else
...
#Release: 0.5.%{?snapdate}%{?rcver}%{?dist}.art.art
#%else
Release: 541.cloudlinux.redbottle
#%endi
...
# CloudLinux CageFS
## Use the Autoconf-variant of the patch instead, since RPM uses autoconf.
## The other patch modifies the configure script.
Patch50: fpm-lve-php5.4_autoconf.patch
#Patch51: fpm-lve-php5.4.patch
...
# Test patch
Patch100: ssl_read_timeout-5.4.33.patch
...
%{!?scl:Obsoletes: php53-cli, php53u-cli, php54-cli}
%{!?scl:Provides: php53-cli, php53u-cli, php54-cli}
...
%endif
%{!?scl:Obsoletes: php53-fpm, php53u-fpm, php54-fpm}
...
Obsoletes: %{?scl_prefix}php-pecl-json < 1.2.2
Obsoletes: %{?scl_prefix}php-pecl-phar < 1.2.4
Obsoletes: %{?scl_prefix}php-pecl-Fileinfo < 1.0.5
Obsoletes: %{?scl_prefix}php-mhash < 5.3.0
%{!?scl:Obsoletes: php53-mhash, php53u-mhash}
%{!?scl:Obsoletes: php53-common, php53u-common, php54-common}
...
%{!?scl:Obsoletes: php53-devel, php53u-devel, php54-devel}
...
%{!?scl:Obsoletes: php53-imap, php53u-imap, php54-imap}
...
%{!?scl:Obsoletes: php53-ldap, php53u-ldap, php54-ldap}
...
%{!?scl:Obsoletes: php53-pdo, php53u-pdo, php54-pdo}
%{!?scl:Obsoletes: php-sqlite php-sqlite2}
...
%{!?scl:Obsoletes: php53-mysql, php53u-mysql, php54-mysql}
...
Provides: %{?scl_prefix}php-mysqli%{?_isa} = %{version}-%{release}
Provides: %{?scl_prefix}php-pdo_mysql, %{?scl_prefix}php-pdo_mysql%{?_isa}
%{!?scl:Obsoletes: php53-mysqlnd, php53u-mysqlnd, php54-mysqlnd}
...
%{!?scl:Obsoletes: php53-pgsql, php53u-pgsql, php54-pgsql}
...
%{!?scl:Obsoletes: php53-process, php53u-process, php54-process}
...
%{!?scl:Obsoletes: php53-odbc, php53u-odbc, php54-odbc}
...
%{!?scl:Obsoletes: php53-soap, php53u-soap, php54-soap}
...
%{!?scl:Obsoletes:  php53-interbase, php53u-interbase, php54-interbase}
...
Requires:       %{?scl_prefix}php-pdo%{?_isa} = %{version}-%{release}
Provides:       %{?scl_prefix}php_database
Provides:       %{?scl_prefix}php-pdo_oci = %{oci8ver}, %{?scl_prefix}php-pdo_oci%{?_isa} = %{oci8ver}
...
AutoReq:        0
%{!?scl:Obsoletes:      php53-oci8, php53u-oci8, php54-oci8}
...
%{!?scl:Obsoletes: php53-snmp, php53u-snmp, php54-snmp}
...
%{!?scl:Obsoletes: php53-xml, php53u-xml, php54-xml}
...
License: PHP and BSD
Requires: %{?scl_prefix}php-common%{?_isa} = %{version}-%{release}
%{!?scl:Obsoletes: php53-xmlrpc, php53u-xmlrpc, php54-xmlrpc}
...
Requires: %{?scl_prefix}php-common%{?_isa} = %{version}-%{release}
%{!?scl:Obsoletes: php53-mbstring, php53u-mbstring, php54-mbstring}
...
%{!?scl:Obsoletes: php53-gd, php53u-gd, php54-gd}
...
Requires: %{?scl_prefix}php-common%{?_isa} = %{version}-%{release}
%{!?scl:Obsoletes: php53-bcmath, php53u-bcmath, php54-bcmath}
...
Requires: %{?scl_prefix}php-common%{?_isa} = %{version}-%{release}
%{!?scl:Obsoletes: php53-dba, php53u-dba, php54-dba}
...
%{!?scl:Obsoletes: php53-mcrypt, php53u-mcrypt, php54-mcrypt}
...
%{!?scl:Obsoletes: php53-tidy, php53u-tidy, php54-tidy}
...
%{!?scl:Obsoletes: php53-mssql, php53u-mssql, php54-mssql}
...
%{!?scl:Obsoletes: php53-embedded, php53u-embedded, php54-embedded}
...
%{!?scl:Obsoletes: php53-pspell, php53u-pspell, php54-pspell}
...
%{!?scl:Obsoletes: php53-recode, php53u-recode, php54-recode}
...
%{!?scl:Obsoletes: php53-intl, php53u-intl, php54-intl}
...
%{!?scl:Obsoletes: php53-enchant, php53u-enchant, php54-enchant}
...
install -m 755 -d $RPM_BUILD_ROOT%{_root_sysconfdir}/
...
install -D -m 644 %{SOURCE9} $RPM_BUILD_ROOT%{_httpd_confdir}/%{?scl_prefix}php.conf
cat %{SOURCE1} >>$RPM_BUILD_ROOT%{_httpd_confdir}/%{?scl_prefix}php.conf
%else
# Dual config file with httpd >= 2.4 (fedora >= 18)
install -D -m 644 %{SOURCE9} $RPM_BUILD_ROOT%{_httpd_modconfdir}/10-%{?scl_prefix}php.conf
install -D -m 644 %{SOURCE1} $RPM_BUILD_ROOT%{_httpd_confdir}/%{?scl_prefix}php.conf
%endif
...
ln -s %{_httpd_moddir}/libphp5.so $RPM_BUILD_ROOT%{_root_httpd_moddir}/lib%{atomicname}.so
ln -s %{_httpd_moddir}/libphp5-zts.so $RPM_BUILD_ROOT%{_root_httpd_moddir}/lib%{atomicname}-zts.so
%endif
...
# Config
install -m 755 -d $RPM_BUILD_ROOT%{_root_sysconfdir}/php-fpm.d
install -m 644 %{SOURCE4} $RPM_BUILD_ROOT%{_root_sysconfdir}/%{?scl_prefix}php-fpm.conf
install -m 644 %{SOURCE5} $RPM_BUILD_ROOT%{_root_sysconfdir}/php-fpm.d/%{?scl_prefix}www.conf
...
# tmpfiles.d
install -m 755 -d $RPM_BUILD_ROOT%{_root_prefix}/lib/tmpfiles.d
install -m 644 php-fpm.tmpfiles $RPM_BUILD_ROOT%{_root_prefix}/lib/tmpfiles.d/%{?scl_prefix}php-fpm.conf
...
sed -i -e 's:/run:/var/run:' $RPM_BUILD_ROOT%{_root_sysconfdir}/%{?scl_prefix}php-fpm.conf
sed -i -e 's:/run:/var/run:' $RPM_BUILD_ROOT%{_root_sysconfdir}/logrotate.d/%{?scl_prefix}php-fpm
# Service
install -m 755 -d $RPM_BUILD_ROOT%{_root_initddir}
install -m 755 %{SOURCE99} $RPM_BUILD_ROOT%{_root_initddir}/%{?scl_prefix}php-fpm
%endif
# Environment file
...
install -m 644 -c macros.php \
           $RPM_BUILD_ROOT%{_sysconfdir}/rpm/macros.%{name}
...
%{?scl: %{_root_httpd_moddir}/lib%{atomicname}.so}
%{?scl: %{_root_httpd_moddir}/lib%{atomicname}-zts.so}
%attr(0770,root,apache) %dir %{_localstatedir}/lib/php/session
%config(noreplace) %{_httpd_confdir}/%{?scl_prefix}php.conf
%if "%{_httpd_modconfdir}" != "%{_httpd_confdir}"
%config(noreplace) %{_httpd_modconfdir}/10-%{?scl_prefix}php.conf
%endif
...
%doc fpm_LICENSE
%config(noreplace) %{_root_sysconfdir}/%{?scl_prefix}php-fpm.conf
%config(noreplace) %{_root_sysconfdir}/php-fpm.d/%{?scl_prefix}www.conf
...
%if %{with_systemd}
%{_root_prefix}/lib/tmpfiles.d/%{?scl_prefix}php-fpm.conf
%{_unitdir}/%{?scl_prefix}php-fpm.service
%dir /run/php-fpm
%else
# el5
#/etc/rc.d/init.d/%{?scl_prefix}php-fpm
%{_root_initddir}/%{?scl_prefix}php-fpm
%dir %{_localstatedir}/run/php-fpm
%endif
%{_sbindir}/php-fpm
%dir %{_root_sysconfdir}/php-fpm.d
...
%changelog
* Thu Dec 04 2014 Guy A. Paddock <guy.paddock@redbottledesign.com> 5.4.35-541
- Added CloudLinux patches for CageFS for PHP-FPM.

* Mon Nov 17 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.35-41
- Update to 5.4.35

* Wed Oct 22 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.34-40
- Update to 5.4.34

* Tue Oct 14 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.33-39
- Revert openssl changes to vanilla 5.4.32 code

* Tue Sep 23 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.33-38
- Update to 5.4.33

* Sat Aug 30 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.32-38
- Update to 5.4.32

* Wed Jul 30 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.31-37
- Update to 5.4.31

* Fri Jun 27 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.30-36
- Update to 5.4.30

* Sun Jun 1 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.29-35
- Update to 5.4.29

* Fri May 2 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.28-34
- Update to 5.4.28

* Mon Apr 7 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.27-33
- Update to 5.4.27

* Wed Mar 12 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.26-32
- Update to 5.4.26

* Mon Feb 10 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.25-31
- Update to 5.4.25

* Mon Jan 13 2014 Scott R. Shinn <scott@atomicorp.com> 5.4.24-30
- Update to 5.4.24

* Fri Dec 13 2013 Scott R. Shinn <scott@atomicorp.com> 5.4.23-29
- Update to 5.4.23
- Security fix for CVE-2013-6420

* Mon Nov 18 2013 Scott R. Shinn <scott@atomicorp.com> 5.4.22-28
- Update to 5.4.22

* Fri Oct 18 2013 Scott R. Shinn <scott@atomicorp.com> 5.4.21-27
- Update to 5.4.21

* Tue Sep 24 2013 Scott R. Shinn <scott@atomicorp.com> 5.4.20-26
- Update to 5.4.20
- Add SCL conditionals

* Tue Aug 27 2013 Scott R. Shinn <scott@atomicorp.com> 5.4.19-25
- Update to 5.4.19

* Mon Aug 19 2013 Scott R. Shinn <scott@atomicorp.com> 5.4.18-24
- Update to 5.4.18
- Security fix for CVE-2013-4248

* Thu Aug  1 2013 Scott R. Shinn <scott@atomicorp.com> 5.4.17-23
- Update to 5.4.17

* Thu Jun  13 2013 Scott R. Shinn <scott@atomicorp.com> 5.4.16-22
- Resync with Remi (always a pro!) for 5.4. +1 internets to you for obsoletes on php53/php54
- Set pcre to use internal library for el5 and el6
- Add Obsoletes on legacy plesk php-sqlite and php-sqlite2 packages
